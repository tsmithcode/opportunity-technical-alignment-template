...
9. Run `python3 scripts/verify_readiness.py`.
10. Start a local server and verify the rendered HTML has no horizontal overflow.
11. Commit and push.
12. If GitHub Pages is enabled, wait for Pages to build and verify the rendered URL.
